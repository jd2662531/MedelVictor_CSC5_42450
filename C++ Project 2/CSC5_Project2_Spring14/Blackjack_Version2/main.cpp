...
/*
 * I attempted to use 2D array but it was not functional with the Blackjack
 * game I was developing. I've included the code to demonstrated my attempt.
 * 
